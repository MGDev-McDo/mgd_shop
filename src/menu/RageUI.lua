...
function RageUI.Info(Title, RightText, LeftText)
    ...
    if Title ~= nil then
        RenderText(Title, 330 + 20 + 100, 7, 0, 0.33, 255, 255, 255, 255, 0)
    end
    if RightText ~= nil then
        RenderText(table.concat(RightText, "\n"), 330 + 20 + 100, Title ~= nil and 37 or 7, 0, 0.30, 255, 255, 255, 255, 0)
    end
    if LeftText ~= nil then
        RenderText(table.concat(LeftText, "\n"), 330 + 432 + 100, Title ~= nil and 37 or 7, 0, 0.30, 255, 255, 255, 255, 2)
    end
